    ...
    <g id="XMLID_3_">
      <g id="XMLID_62_">
        <g id="XMLID_1228_">
          ...
          <path
            id="XMLID_1229_"
            fill="#F3D8B6"
            d="M248.986,236.042c-18.667-6.681-51.458-11.736-51.458-81.376h-29.23h-5.002
        ...
        <path
          id="XMLID_1230_"
          fill="#F3D8B6"
          d="M197.528,154.666h-29.23h-2.501v135.472c1.579,0.491,2.501,0.68,2.501,0.68
      ...
      <g id="XMLID_55_">
        ...
        <path
          id="XMLID_1233_"
          fill="var(--black)"
          d="M285.326,290.913v40.681H45.363v-40.681c0-30.431,17.377-56.963,40.605-70.913
        ...
        <path
          id="XMLID_1236_"
          fill="var(--black)"
          d="M245.627,220c-6.042-3.641-19.69-7.43-26.844-9.196
      ...
      <g id="XMLID_52_">
        ...
        <path
          id="XMLID_1237_"
          fill="#F3DBC4"
          d="M165.799,176.828c-27.454,0-48.409-23.119-57.799-40.456
        ...
        <path
          id="XMLID_1238_"
          fill="#F3DBC4"
          d="M219.257,29.476c-19.81-26.883-53.458-13.838-53.458-13.838h-0.002v161.191
      ...
      <g id="XMLID_45_">
        ...
        <path
          id="XMLID_1241_"
          fill="var(--black)"
          d="M223.252,25.321c-2.159,0.08-12.282-31.303-39.282-24.303
        ...
        <path
          id="XMLID_1244_"
          fill="var(--black)"
          d="M223.252,25.322c-2.159,0.08-12.282-31.303-39.282-24.303
      ...
      <g id="XMLID_42_">
        ...
        <ellipse
          id="XMLID_44_"
          transform="matrix(0.3543 -0.9351 0.9351 0.3543 45.161 283.6375)"
          fill="#F3DBC4"
          cx="227.971"
          cy="109.116"
          rx="17.187"
        ...
        <ellipse
          id="XMLID_43_"
          transform="matrix(0.3543 0.9351 -0.9351 0.3543 168.9501 -26.4359)"
          fill="#F3DBC4"
          cx="103.618"
          cy="109.124"
          rx="17.187"
      ...
      <g id="XMLID_38_">
        ...
        <g id="XMLID_1245_">
          <polygon
            id="XMLID_1246_"
            fill="var(--red)"
            points="213.458,331.594 118.136,331.594 118.136,204.664 165.797,218.388 
				213.458,204.664 			"
          />
        </g>
        <polygon
          id="XMLID_1247_"
          fill="var(--red)"
          points="165.797,218.388 165.797,331.594 213.458,331.594 213.458,204.664 		"
        />
      </g>
      <g id="XMLID_4_">
        {/* collar */}
        <path
          id="XMLID_35_"
          fill="var(--black)"
          d="M126.777,201.164c0,0-32.452,8.501-39.684,18.626
        ...
        <path
          id="XMLID_1251_"
          fill="var(--black)"
          d="M204.817,201.164c0,0,32.452,8.501,39.684,18.626

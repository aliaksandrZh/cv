  ...
  return (
    <main className="container mx-auto flex border-t-4 border-black pt-10">
      <section className="w-3/12 pr-5">
        ...
        <div
          className="test-hover-item mt-7"
        ...
        >
          ...
          <ListHoverEffect>
            <li className="hover-list-item-vertical" key="1">
              Developed and maintained web applications using technologies such
              as JavaScript, TypeScript, .Net, React, Angular, NodeJS, and SQL.
            </li>
      ...
      <section className="w-3/4 border-l-4 border-black pl-10">
        ...
        >
          ...
          <p className="mt-3 text-justify">
            ...
            full-stack development. Recently returned to the workforce after a
        ...
        <section className="mt-7">
          <h3>Projects</h3>
          <article
            className="test-hover-item mt-5"
            onMouseEnter={handleMouseEnter}
            onMouseLeave={handleMouseLeave}
          >
            ...
            <p className="mt-2 text-justify">
              ...
              solutions. The GTP is designed to help organizations manage their
              tax functions more effectively by leveraging data and technology
              to transform, grow, and operate efficiently.
            </p>
            ...
            <ListHoverEffect>
              ...
              <li key="3" className="hover-list-item-vertical">
                ...
                and reducing technical debt, leading to improved maintainability
                and scalability.
              </li>
              ...
              <li key="3">
                <ul>
                  ...
                  <li className="hover-list-item-vertical pl-5">
                    ...
                    audio input, but there`s also a menu bar extension showing
                    if it`s either muted or not, and lets you click on the menu
                    item to toggle its state.
                  </li>
                  <li className="hover-list-item-vertical pl-5">
                    <b>1.5k+</b> downloads
                  </li>
